...
- **Ações:** expandir/colapsar matérias/assuntos (l.4210–4217); links por assunto "▶ Assistir aula" (busca no YouTube) e "✎ Fazer questões" (qconcursos.com) — l.4184–4187; ***desde a dec. 202 (15/08)***, **botão de play** em cada subassunto (`.ed-q10`; ícone da dec. 203) abrindo o bloco de 10 questões de revisão daquele conteúdo (`trAbrirSub`, src/11) — apagado com aviso quando o assunto não tem cartas (proposital: acende pela presença de cartas matéria+assunto no banco, sem lista fixa); subassuntos numerados 1.1.1; a árvore preserva o que estava aberto ao se redesenhar.
