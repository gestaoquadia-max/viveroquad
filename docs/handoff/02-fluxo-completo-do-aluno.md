...
| 17 · Estornos | "Estornos · até 7 dias" e Relatório (src/19); consumo nas Liberações (src/17 l.367–550) | `vfased.mjs`, `vk1.mjs`, `vo1.mjs`, `vu1.mjs`, `vv1.mjs` (tutorial/evento realizado) |
